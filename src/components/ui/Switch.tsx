  ...
  return (
    ...
    >
      ...
      <div className="relative w-10 h-5">
        ...
        <div
          className={clsx(
            'w-full h-full rounded-full border transition-colors shadow-inner',
            checked ? 'bg-accent/25 border-accent' : 'bg-surface/80 border-border-color',
            trackClassName,
          )}
        />
        <motion.div
          className={clsx('absolute top-0.5 left-0.5 w-4 h-4 rounded-full shadow-xs transition-colors', {
            'bg-accent': checked,
