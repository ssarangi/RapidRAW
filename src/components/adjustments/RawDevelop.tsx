      ...
      <div className="grid gap-2">
        ...
        >
          <div className="flex items-center gap-3">
            <span
              className={`flex h-6 w-6 shrink-0 items-center justify-center rounded-sm ${adjustments.rawAiDenoiseEnabled ? 'bg-[#d89538]/15 text-[#e9ab4a]' : 'bg-surface text-text-secondary'}`}
            >
              <Sparkles size={14} />
            </span>
