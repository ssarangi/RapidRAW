...
export default function InsightsView() {
  ...
  const summary = metrics ? [['Images', metrics.totalImages], ['Rated', metrics.ratedImages], ['Edited', metrics.editedImages], ['Missing', metrics.missingImages], ['AI pending', metrics.aiTagsSuggested], ['AI accepted', metrics.aiTagsAccepted], ['Cull sessions', metrics.cullSessions], ['Overrides', metrics.cullOverrides]] : [];
