...
pub fn visual_model_packs() -> Vec<VisualModelPack> {
    vec![
        ...
        // Upstream taxonomy revision: a8f38b4388579862c56ae57d6f094c2ac0e92e12
        // Generated by scripts/export_bioclip2_onnx.py; the taxonomy is split
        // below GitHub's per-asset limit while retaining all valid upstream rows.
        VisualModelPack {
            id: BIOCLIP_V2_MODEL_ID.to_string(),
            display_name: "BioCLIP 2 (Highest accuracy)".to_string(),
            description: "Highest-accuracy biological species classification. Uses the BioCLIP 2 ViT-L/14 encoder and 851,968-entry Tree-of-Life taxonomy. Requires roughly 3.8 GB of disk space and substantial RAM.".to_string(),
            task: "Wildlife and species classification".to_string(),
            availability: VisualModelAvailability::DirectDownload,
            artifacts: vec![
                visual_artifact(
                    "vision_encoder.onnx",
                    "https://github.com/ssarangi/RapidRAW/releases/download/v0.2.0-models/vision_encoder.onnx",
                    Some("708aa4ffa60fbc6e8d39dc61106224fc6f25260fda7c0c1e7fbdbd1bdda55023"),
                ),
                visual_artifact(
                    "species_labels.json",
                    "https://github.com/ssarangi/RapidRAW/releases/download/v0.2.0-models/species_labels.json",
                    Some("22da5d6c3c94b19501f4e686131079f225964085cbef7a469ce64b4550d67e0c"),
                ),
                visual_artifact(
                    "taxonomy_manifest.json",
                    "https://github.com/ssarangi/RapidRAW/releases/download/v0.2.0-models/taxonomy_manifest.json",
                    Some("db8cdab8b63d84dba56a600c6cc582111ccd4bfdf9e43436efe4b8bef4fde2b7"),
                ),
                visual_artifact(
                    "species_embeddings.000.bin",
                    "https://github.com/ssarangi/RapidRAW/releases/download/v0.2.0-models/species_embeddings.000.bin",
                    Some("99f6bcc03cdb1e55a40f1326169cfcf4a316eba93f887e1285874dbf6b0d34be"),
                ),
                visual_artifact(
                    "species_embeddings.001.bin",
                    "https://github.com/ssarangi/RapidRAW/releases/download/v0.2.0-models/species_embeddings.001.bin",
                    Some("64450a6529a6b2f725a4115ad31cf05dbfa41cb12a1082ea66fb77e492f8459c"),
                ),
                visual_artifact(
                    "species_embeddings.002.bin",
                    "https://github.com/ssarangi/RapidRAW/releases/download/v0.2.0-models/species_embeddings.002.bin",
                    Some("5c91885446cfd4ec73ad23fcfd0a52a6800c83504704ab2bf546e9f5073ee5d9"),
                ),
            ],
            license_name: "MIT".to_string(),
            license_url: "https://huggingface.co/imageomics/bioclip-2".to_string(),
            model_source_url: "https://github.com/Imageomics/bioclip-2".to_string(),
        },
