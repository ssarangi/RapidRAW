...
pub use culling::{CullingSettings, HeadlessCullingReport, cull_images_headless};
pub use file_management::resolve_auto_cull_path_candidates;
...
pub fn run() {
    ...
    builder
        ...
        .manage(AppState {
            ...
            catalog_scan_state: CatalogScanState::new(),
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            library_db::get_catalog_face_processing_settings,
            library_db::set_catalog_face_processing_settings,
            face_model_registry::list_face_model_packs,
            face_model_registry::list_face_model_pack_statuses,
            face_model_registry::resolve_face_model_selection,
            ...
            visual_model_registry::remove_visual_model_pack,
            face_detection::start_face_detection,
            face_detection::start_face_recognition,
            face_detection::reprocess_face_index,
            ...
            gemini_critique::interpret_gemini_catalog_search,
            ...
            library_db::list_catalog_person_cover_candidates,
            library_db::set_catalog_person_cover,
            library_db::search_catalog_people,
            ...
            library_db::review_catalog_faces,
